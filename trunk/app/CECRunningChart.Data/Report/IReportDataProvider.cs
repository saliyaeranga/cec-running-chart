...
namespace CECRunningChart.Data.Report
{
    public interface IReportDataProvider
    {
        ...
        DataSet GetDriverTimeSheetReport(string driverName, DateTime startDate, DateTime endDate);
        DataSet GetDriverNames();
        ...
        DataSet GetWorkDoneReport(DateTime startDate, DateTime endDate, int vehicleId);
    }
}
